...
bar (`|`): a list of winning numbers and then a list of numbers you have. You organize the information into a table (
your puzzle input).
...
- Card 5 has no winning numbers, so it is worth `0` points.
- Card 6 has no winning numbers, so it is worth `0` points.
...
Once all the originals and copies have been processed, you end up with 1 instance of card 1, 2 instances of card 2, 4
...
Your puzzle answer was 7013204.
